...
insert into Authors values (15, 'Ernst Weiﬂ');
...
insert into Titles values ('3423114118', 'Die Wasserf‰lle von Slunj', 'de');
...
insert into Titles values ('3442730503', 'Naokos L‰cheln', 'de');
...
create view GermanBooks
as select ISBN10, Title
     from Titles
	where Language = 'de'
go	
...
insert into GermanBooks values ('3746656362', 'Goya');
go
