...
insert into Suppliers values('L1', 'Schmid', 'London', 20, null, null);
insert into Suppliers values('L2', 'Jonas', 'Paris', 10, null, null);
insert into Suppliers values('L3', 'Berger', 'Paris', 30, null, null);
insert into Suppliers values('L4', 'Klein', 'London', 20, null, null);
insert into Suppliers values('L5', 'Adam', 'Athen', 30, null, null);
...
select * from Suppliers
 where TotalAmount > MaxTotalAmount
;
go

create trigger InsteadOfInsUpdSuppliers
on Suppliers
...
begin
	...
	begin
		raiserror('TotalAmount > MaxTotalAmount', 16, 1);
	end
end
go
...
insert into SupplierParts values ('L5', 'T1', 100);
